...
void *handleTraversal(void *arg)
{
    ...
    if (op_no == 3)
    {
        printf("Secondary Server 2: Performing DFS, start node: %d\n", startNode);
    ...
    {
        printf("Secondary Server 2: Performing BFS, start node: %d\n", startNode);
    ...
    {
        printf("Secondary Server 2: Unknown Operation: %d\n", op_no);
    }
...
void cleanupHandler()
{
    ...
    printf("Secondary Server 2: Cleanup initiated. Performing cleanup actions...\n");
